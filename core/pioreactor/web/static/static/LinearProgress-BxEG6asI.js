import{ab as T,ac as A,r as U,ag as D,ax as E,j as g,ak as S,al as x,am as X,s as m,ae as c,ao as u,bm as h,af as p,bn as j,aM as M}from"./index-DaH6BU5p.js";function K(a){return T("MuiLinearProgress",a)}const Z=A("MuiLinearProgress",["root","colorPrimary","colorSecondary","determinate","indeterminate","buffer","query","dashed","bar","bar1","bar2"]),C=4,w={},k=M`
  0% {
    left: -35%;
    right: 100%;
  }
