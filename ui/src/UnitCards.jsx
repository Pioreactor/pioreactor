...
class UnitSettingDisplay extends React.Component {
  ...
  onConnect() {
      this.client.subscribe("morbidostat/" + this.props.unitNumber + "/" + "Trial-18-e149d09a68f64045bd6f162dcf28f15c" + "/" + this.props.job + "/" + this.props.attr, {qos: 1})
  }
  ...
  function UnitSettings(props) {
    ...
    function setActiveState(job, state) {
      return function () {
        ...
        message.destinationName = "morbidostat/" + unitNumber + "/Trial-18-e149d09a68f64045bd6f162dcf28f15c/" + job + "/active/set";
        message.qos = 1
    ...
    function setMorbidostatJobState(job_attr, value) {
        ...
        message.destinationName = "morbidostat/" + unitNumber + "/Trial-18-e149d09a68f64045bd6f162dcf28f15c/" + job_attr + "/set" ;
        message.qos = 1
        client.publish(message);
    }
