...
def growth_rate_calculating(verbose=False):
    ...
    try:
        ...
        observation_noise_covariance = 1e-3 * np.eye(d - 1)  # TODO: this should be a function of the angle.
        ...
        while True:
            ...
            if "od_raw" in msg.topic:
                ...
                ekf.scale_OD_variance_for_next_n_steps(1e2, 8 * samples_per_minute)
                continue
