    ...
    <Box sx={{ width: "100%", minWidth: { md: 520 } }}>
      ...
      {props.name === "chemostat" && dilutionRate !== null &&
        <Typography variant="body1" sx={{ whiteSpace: "pre-line", mt: 0, mb: 1, padding: "6px 6px" }}>
          The current computed <UnderlineSpan title="Exchange volume * (60 / Time between dosing) / (Steady state volume)">dilution rate</UnderlineSpan> is <Box component="code" sx={{backgroundColor: uiColors.codeBackground, padding: "1px 4px"}}>{dilutionRate.toFixed(2)} h⁻¹</Box>.
        </Typography>
      }
