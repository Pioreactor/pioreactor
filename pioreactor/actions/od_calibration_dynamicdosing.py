...
def get_metadata_from_user() -> tuple[pt.OD600, pt.OD600, pt.mL, pt.PdAngle, pt.PdChannel]:
    ...
    echo("By default, the calibration will use dynamic dosing to create a dilution series... ")
    echo("This will require at least 8 data points.")
    echo("You will need at least 30mL of media available.")
        ...
        while inferred_od600 > minimum_od600:
            ...
            for i in range(n_samples):
                ...
                if f_prime(inferred_od600) > 0.1 and abs(f_primeprime(inferred_od600)) < tolerance: 
                    echo("Suffiecent data points acquired. Stopping data collection.")
                    sleep(1)
                    break
                ...
                if dilution_amount < 8:
                    dilution_amount = dilution_amount * 2
